...
abstract class AbstractAlliancesRankingProcessor : Processor {
    fun filterEpochs(
        alliancesRankings: List<AlliancesRanking>,
        firstEpoch: Int? = null,
        lastEpoch: Int? = null,
    ): List<AlliancesRanking> {
    ...
    fun filterRankings(
        alliancesRankings: List<AlliancesRanking>,
        firstRanking: Int? = null,
        lastRanking: Int? = null,
    ): List<AlliancesRanking> {
        val alliancesRankingsWithFirstRankingsFiltered =
        ...
        val alliancesRankingsWithLastRankingsFiltered =
            if (lastRanking != null) {
